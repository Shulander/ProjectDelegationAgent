...
public class Gestor extends Agent {
			...
			if (msg != null) {
				...
				if (msg.getContent().equals("ListaAtividades")) {
					...
					try {
						...
						System.out.println("Gestor: enviei a resposta ao "
								+ msg.getSender().getLocalName() + ".");
					} catch (IOException e) {
						System.out
								.println("Gestor: Erro ao enviar listaAtividades ao "
										+ msg.getSender().getLocalName() + "!");
						e.printStackTrace();
					}
					send(resposta);
	...
	public void setPrioridadeAtividades(
			Hashtable<Integer, Atividade> prioridadeAtividades) {
