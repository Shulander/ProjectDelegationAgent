...
public class CompatibilidadeTarefaService {
	...
	/**
	 * Calcula o grau de compatibilidade entre uma atividade e um conjunto de habilidades
	 * 
	 * @param atividade
	 * @param habiliades
	 * @return retorna a media dos coeficientes encontrados.
	 */
	public static double calculaGrauCompatibilidade(Atividade atividade,
			Collection<Habilidade> habiliades) {
		double retorno = 0.0;
		...
		// calcula a media ponderada (levando em conta o nivel exigido pela habilidade)
	...
	public static Atividade selecionaAtividadeHabilidade(
			Collection<Atividade> atividadesDisponiveis,
			Collection<Habilidade> habiliades,
			Collection<Atividade> atividadesInvalidas) {
